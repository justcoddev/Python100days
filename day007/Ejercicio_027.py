# 5)	Hacer un programa para ingresar por teclado el nombre, sueldo y la antigüedad de los 30 empleados de una
# # empresa. Cada registro está compuesto por los siguientes datos:
